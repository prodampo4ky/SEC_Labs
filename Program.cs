                ...
                while (!isDone)
                {
                    try
                    {
                        ...
                        switch (Switch)
                        {
                            case 1:
                                isDone = true;
                                pathIN = @"C:\Users\artem\Desktop\7_sem\sec_inf\4lab\Lab4\Gimn.txt";
                                break;
                            case 2:
                                isDone = true;
                                pathIN = @"C:\Users\artem\Desktop\7_sem\sec_inf\4lab\Lab4\\Epoxa.txt";
                                break;
                            case 3:
                                isDone = true;
                                pathIN = @"C:\Users\artem\Desktop\7_sem\sec_inf\4lab\Lab4\1.txt";
                                break;
